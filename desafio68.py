...
while True:
    ...
    print('*-'*30)
    if soma % 2 == 0:
        print(f'Você jogou {usernum} e o camputador jogou {compnum}. Total de {soma}, logo deu PAR')
    else:
        print(f'Você jogou {usernum} e o camputador jogou {compnum}. Total de {soma}, logo deu IMPAR')
    print('*-'*30)
