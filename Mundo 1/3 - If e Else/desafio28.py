...
pergunta = int(input('Vamos jogar um game onde o objetivo é acertar o numero que "pensei"? (digite 1 para "SIM" e 2 para "NÃO") ')) #condição com o objetivo de saber se o player jogará
...
if pergunta == 1: #caso o valor seja 1, o jogador será inserido nesse "if" e começará o jogo.
    ...
    print('Entendo, que pena que não quer jogar comigo ;(') #print com o objetivo de encerramento.
